...
void main() {
  final SmsConsentForOtpAutofillPlatform initialPlatform = SmsConsentForOtpAutofillPlatform.instance;

  test('$MethodChannelSmsConsentForOtpAutofill is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelSmsConsentForOtpAutofill>());
  });

  test('getPlatformVersion', () async {
    SmsConsentForOtpAutofill smsConsentForOtpAutofillPlugin = SmsConsentForOtpAutofill();
    MockSmsConsentForOtpAutofillPlatform fakePlatform = MockSmsConsentForOtpAutofillPlatform();
